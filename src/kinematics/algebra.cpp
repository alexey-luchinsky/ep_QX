...
dbl_type lcv(dbl_type (&v1)[4], dbl_type (&v2)[4], dbl_type (&v3)[4], dbl_type (&v4)[4]) {
    return v1[3]*v2[2]*v3[1]*v4[0] - v1[2]*v2[3]*v3[1]*v4[0] - v1[3]*v2[1]*v3[2]*v4[0] + v1[1]*v2[3]*v3[2]*v4[0] + v1[2]*v2[1]*v3[3]*v4[0] - v1[1]*v2[2]*v3[3]*v4[0] - v1[3]*v2[2]*v3[0]*v4[1] + v1[2]*v2[3]*v3[0]*v4[1] + v1[3]*v2[0]*v3[2]*v4[1] - v1[0]*v2[3]*v3[2]*v4[1] - v1[2]*v2[0]*v3[3]*v4[1] + v1[0]*v2[2]*v3[3]*v4[1] + v1[3]*v2[1]*v3[0]*v4[2] - v1[1]*v2[3]*v3[0]*v4[2] - v1[3]*v2[0]*v3[1]*v4[2] + v1[0]*v2[3]*v3[1]*v4[2] + v1[1]*v2[0]*v3[3]*v4[2] - v1[0]*v2[1]*v3[3]*v4[2] - v1[2]*v2[1]*v3[0]*v4[3] + v1[1]*v2[2]*v3[0]*v4[3] + v1[2]*v2[0]*v3[1]*v4[3] - v1[0]*v2[2]*v3[1]*v4[3] - v1[1]*v2[0]*v3[2]*v4[3] + v1[0]*v2[1]*v3[2]*v4[3];
};
...
void lepton_current(int state, dbl_type (&p1)[4], dbl_type (&p2)[4], cmplx (&eps)[4]) {
    ...
    cmplx norm=1;
    if(state==0) {
        eps[0]=-((-(II*p1[1]) + p1[2])*(-(II*p2[1]) - p2[2])) - (-p1[0] + p1[3])*(-p2[0] + p2[3]);
        eps[1]=II*(-p1[0] + p1[3])*(-(II*p2[1]) - p2[2]) - II*(II*p1[1] - p1[2])*(-p2[0] + p2[3]);
        eps[2]=-((-p1[0] + p1[3])*(-(II*p2[1]) - p2[2])) - (II*p1[1] - p1[2])*(-p2[0] + p2[3]);
        eps[3]=(II*p1[1] - p1[2])*(-(II*p2[1]) - p2[2]) + (-p1[0] + p1[3])*(-p2[0] + p2[3]);
       norm=4*(-(p1[2]*p1[3]*p2[0]*p2[2]) + p1[2]*p1[3]*p2[2]*p2[3] + p1[1]*p1[3]*p2[1]*(-p2[0] + p2[3]) + p2[0]*p2[3]*pow(p1[2],2) + pow(p1[2],2)*pow(p2[1],2) - pow(p1[3],2)*pow(p2[1],2) + pow(p1[2],2)*pow(p2[2],2) - pow(p1[3],2)*pow(p2[2],2) + pow(p1[1],2)*((p2[0] - p2[3])*p2[3] + pow(p2[1],2) + pow(p2[2],2)) + p1[0]*(p1[1]*p2[1]*(p2[0] - p2[3]) + p1[2]*p2[2]*(p2[0] - p2[3]) + p1[3]*(pow(p2[1],2) + pow(p2[2],2))) - pow(p1[2],2)*pow(p2[3],2));
         norm = -4*sp(p1,p2)/norm;
//         norm=norm/(4*(p1[2] - p1[3])*(p2[2] - p2[3])*(p1[0]*p2[0] + p1[1]*p2[1] + p1[2]*p2[2] - p1[3]*p2[3]));
    }
    else if(state==1) {
	 eps[0]=(II*p1[1] - p1[2])*(II*p2[1] + p2[2]) + (p1[0] + p1[3])*(p2[0] + p2[3]);
	 eps[1]=-(II*(p1[0] + p1[3])*(II*p2[1] + p2[2])) + II*(-(II*p1[1]) + p1[2])*(p2[0] + p2[3]);
	 eps[2]=(p1[0] + p1[3])*(II*p2[1] + p2[2]) + (-(II*p1[1]) + p1[2])*(p2[0] + p2[3]);
	 eps[3]=(-(II*p1[1]) + p1[2])*(II*p2[1] + p2[2]) + (p1[0] + p1[3])*(p2[0] + p2[3]);
       norm=4*(p1[2]*p1[3]*p2[0]*p2[2] + p1[2]*p1[3]*p2[2]*p2[3] + p1[1]*p1[3]*p2[1]*(p2[0] + p2[3]) - p2[0]*p2[3]*pow(p1[2],2) + pow(p1[2],2)*pow(p2[1],2) - pow(p1[3],2)*pow(p2[1],2) + pow(p1[2],2)*pow(p2[2],2) - pow(p1[3],2)*pow(p2[2],2) + pow(p1[1],2)*(-(p2[3]*(p2[0] + p2[3])) + pow(p2[1],2) + pow(p2[2],2)) + p1[0]*(p1[1]*p2[1]*(p2[0] + p2[3]) + p1[2]*p2[2]*(p2[0] + p2[3]) - p1[3]*(pow(p2[1],2) + pow(p2[2],2))) - pow(p1[2],2)*pow(p2[3],2));
         norm = -4*sp(p1,p2)/norm;
//        norm=norm/(4*(p1[2] + p1[3])*(p2[2] + p2[3])*(p1[0]*p2[0] + p1[1]*p2[1] + p1[2]*p2[2] - p1[3]*p2[3]));
    }
    else {
    ...
    for(int i=0; i<4; ++i) eps[i] = sqrt(norm)*eps[i];
}
